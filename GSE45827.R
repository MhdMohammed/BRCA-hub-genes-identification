...
gsms <- paste0("00000000000000000000000000000000000000000000000000",
               "000000000000000000000XXXXXXXXXXXXXX111111111110000",
...
library(openxlsx)
write.xlsx(x = tT, file = "D:/Dr. Murtada Project/Integration_Gene_exp_data/GSE45827_Results/Diff_genes_less5percent.xlsx", overwrite = TRUE)
...
DEGsData$Class <- gs
write.xlsx(x = DEGsData, file = "D:/Dr. Murtada Project/Integration_Gene_exp_data/GSE45827_Results/DEGsData.xlsx", overwrite = TRUE)
